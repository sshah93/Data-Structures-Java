...
public class MyPriorityQueue 
{
    ...
    public boolean isEmpty()
    {
        if(theQueue.size() == 0)
        {
            System.out.println("\nThe Scheme queue ran out of schemes!\n");
            return true;
        }
    ...
    public void showList() 
    {
        if(theQueue.size() == 0)
        {
            System.out.println("The Customer Queue ran out of customers.");
            return;
        }
    ...
    public static void main(String[] args) 
    {
        ...
        while(!scheme.isEmpty())
        {
            ...
            {       
                ...
                System.out.println("The customer with the highest priority for Scheme " + type + " is " + target.name + " who had a priority of " + target.priority + " for $" + temp.profit);
            
            
            //    System.out.println("There are no more customers!");
            
            /*while(!queue[type].isEmpty() && target != null)     //hashTable.get(target.name) != null &&
            {
